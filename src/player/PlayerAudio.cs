...
public partial class PlayerAudio : Node3D {
  ...
  [ExportCategory("Audio")] [ExportSubgroup("Wind")] [Export]
  private AudioStreamPlayer3D _windRun;
  ...
  [ExportSubgroup("Sprinting")] [Export] private float _minSpeedScale = 0.7f;
  [Export] private float _maxSpeedScale = 1.1f;

  [ExportSubgroup("Sliding")] [Export] private AudioStreamPlayer3D _slideIn;
  [Export] private AudioStreamPlayer3D _slideLoop;

  [ExportSubgroup("Landing")] [Export] private AudioStreamPlayer3D _land;
  [Export] private Array<AudioConditionPlayer> _landPlayers;


  [ExportSubgroup("Step sounds")] [Export]
  private AudioStreamPlayer3D _step;

  [Export] private Array<AudioGroupPlayer> _stepPlayers;
  private string _currentGroup;

  [ExportSubgroup("Vaulting")] [Export] private AudioStreamPlayer3D _vaultIn;
  [Export] private AudioStreamPlayer3D _vaultOut;

  [ExportSubgroup("Wallrun")] [Export] private AudioStreamPlayer3D _wallrun;

  public override void _Ready() {
    CollisionChecker.OnGroupChange += GetStepGroup;
    PlayerAir.LastVelocityChangeLanded += PlayAudioCondition;
  ...
  private void PlayAudioCondition(Vector3 lastVelocity) {
